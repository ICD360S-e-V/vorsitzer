                  ...
                  child: ChoiceChip(
                    label: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 6),
                        Flexible(child: Text('Eingang (${_korrEingang.length})', overflow: TextOverflow.ellipsis)),
                      ],
                    ),
                  ...
                  child: ChoiceChip(
                    label: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 6),
                        Flexible(child: Text('Ausgang (${_korrAusgang.length})', overflow: TextOverflow.ellipsis)),
                      ],
                    ),
