...
class GoogleNonprofitScreen extends StatefulWidget {
  ...
  @override
  State<GoogleNonprofitScreen> createState() => _GoogleNonprofitScreenState();
}

class _GoogleNonprofitScreenState extends State<GoogleNonprofitScreen> {
  ...
  String _website = 'https://www.google.com/nonprofits/';
  ...
  Future<void> _loadCredentials() async {
    try {
      final result = await widget.apiService.getPlatformCredentials('google-nonprofit');
      if (result['success'] == true && result['credentials'] != null) {
        final creds = result['credentials'];
        _emailController.text = creds['email'] ?? '';
        _passwordController.text = creds['password'] ?? '';
        _website = creds['website'] ?? 'https://www.google.com/nonprofits/';
      }
    } catch (_) {}
  }
  ...
  Future<void> _loadNotizen() async {
    try {
      final result = await widget.apiService.getPlatformNotizen('google-nonprofit');
              ...
              children: [
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Titel *',
                    hintText: 'z.B. Google Workspace Zugang beantragen',
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 12),
                                  const Text(
                                    '\u2713 Google Workspace (Gmail, Drive, Docs) kostenlos\n'
                                    '\u2713 Google Ad Grants - \$10.000/Monat Werbeguthaben\n'
                                    '\u2713 YouTube Nonprofit Program\n'
                                    '\u2713 Google Maps Platform Credits\n'
                                    '\u2713 Google Earth & Google One kostenlos',
