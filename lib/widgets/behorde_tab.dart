...
class _BehoerdeTabContentState extends State<BehoerdeTabContent> {
        ...
        builder: (dlgCtx, setDlgState) {
          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: Column(
                children: [
                  // Tab bar (3 tabs: Details | Verlauf | Dokumente)
                  Container(
                    decoration: BoxDecoration(
                  ...
                  Expanded(
                    child: tabIndex == 0
                      ...
                      : tabIndex == 1
                        ...
                        : _buildTerminDokumenteTab(behoerdeType, terminId),
                  ),
                ],
              ),
            ),
  ...
  /// Dokumente-Tab für Termin-Detail: lädt/zeigt Briefumschläge & Anhänge,
  /// die wir von der Behörde erhalten haben (Arbeitsagentur-Einladungen,
  /// Jobcenter-Vorladungen etc.) Pro Behörde-Typ getrennt
  /// (modul = "${behoerdeType}_termin"), Termin-ID = stabile termin_id aus
  /// der zentralen Terminverwaltung.
  Widget _buildTerminDokumenteTab(String behoerdeType, dynamic terminId) {
    if (terminId == null) {
      return Padding(
        padding: const EdgeInsets.all(16),
        child: Container(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              child: Text(
                ...
                'um anschließend Dokumente (z.B. Einladungsbrief der Behörde) anhängen zu können.',
