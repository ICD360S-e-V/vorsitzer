...
class HzvRechtsHinweis extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _z('Widerruf innerhalb von zwei Wochen nach Abgabe der Teilnahmeerklärung, '
              'ohne Angabe von Gründen — schriftlich, elektronisch oder zur Niederschrift.'),
          _z('Danach ist das Mitglied mindestens zwölf Monate an die Teilnahme UND an '
              'den gewählten Hausarzt gebunden.'),
          _z('Vor Ablauf der zwölf Monate ist ein Hausarztwechsel nur aus wichtigem Grund '
              'möglich: die Praxis nimmt nicht mehr teil, Praxis oder Mitglied ziehen um und '
              'die Entfernung ist nicht zumutbar, oder das Vertrauensverhältnis ist gestört.'),
          ...
          Text(
            ...
            'sondern im Vertrag der jeweiligen Kasse und weichen voneinander ab '
            '(AOK Baden-Württemberg: ein Monat zum Ablauf des 12-Monats-Zeitraums, neue '
            'Teilnahmeerklärung zwei Monate vorher · TK: vier Wochen zum Ende des '
            'Teilnahmejahres, danach vier Wochen zum Quartalsende). Deshalb werden sie hier '
            'eingetragen und nicht gerechnet.',
...
class _HzvEditDialogState extends State<HzvEditDialog> {
  ...
  late TextEditingController _unterschriebenC, _eingangC, _beginnC, _bindungC,
      _widerrufC, _kuendAmC, _kuendZumC, _endeC;
  ...
  void initState() {
    ...
    _arztId = e['arzt_id'] is int ? e['arzt_id'] as int : int.tryParse(v('arzt_id'));
  }
  ...
  void dispose() {
    for (final c in [
      ...
      _abgabeDetailC, _fristC, _endeGrundC, _notizC, _unterschriebenC, _eingangC,
      _beginnC, _bindungC, _widerrufC, _kuendAmC, _kuendZumC, _endeC,
    ]) {
      c.dispose();
    }
    super.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    final wBis = hzvWiderrufBis(DateTime.tryParse(_unterschriebenC.text));
      ...
      content: SizedBox(
        ...
        child: SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Row(children: [
              ...
              Expanded(
                child: CheckboxListTile(
                  ...
                  title: const Text('Hausarztwechsel', style: TextStyle(fontSize: 13)),
                ),
              ),
            ]),
            ...
            if (wBis != null)
              _rechnung('Widerruf ohne Begründung möglich bis '
                  '${DateFormat('dd.MM.yyyy').format(wBis)} (zwei Wochen, § 73b Abs. 3 SGB V).'),
            const SizedBox(height: 10),
            Row(children: [
