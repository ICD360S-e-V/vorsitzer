            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  _item(14, Icons.date_range, 'Arbeitsbereich'),
                  ...
                  _item(11, Icons.bug_report_outlined, 'Bug-Berichte'),
                  _item(12, Icons.family_restroom, 'Eltern-Liste'),
                ],
              ),
            ),
          ),
          const Divider(color: Colors.white24, height: 1),
          _item(13, Icons.settings, 'Einstellungen'),
          const SizedBox(height: 8),
        ],
      ),
    );
