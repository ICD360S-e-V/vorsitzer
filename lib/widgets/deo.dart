          ...
          Container(
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(child: Text.rich(TextSpan(style: TextStyle(fontSize: 10, color: Colors.blue.shade800, height: 1.4), children: [
                ...
                const TextSpan(text: 'Öko-Test, Stiftung Warentest, Testberichte.de (Inhaltsstoffe, Schadstoffe, Wirksamkeit)\n'),
                TextSpan(text: '2. Kundenfeedback: ', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.blue.shade900)),
                const TextSpan(text: 'dm.de, Amazon.de, Rossmann.de, Codecheck.info (Erfahrungen, Geruch, Hautverträglichkeit)\n'),
