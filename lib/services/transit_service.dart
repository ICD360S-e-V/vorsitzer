...
enum TransitProviderType {
  ...
  // Added 2026-07-13: 4 major provideri lipsă identificați prin research
  // - HVV Hamburg (~185 comune) — Hamburg + Umland SH/NDS
  // - bodo Bodensee-Oberschwaben (~93 comune) — Ravensburg/Friedrichshafen
...
const _providers = [
  ...
  // ── Added 2026-07-13: 4 major provideri lipsă ──
  //
  // HVV Hamburg — 3.7M locuitori, cel mai mare Verkehrsverbund din Germania
  // de nord. Anterior LIPSEA COMPLET din app (Hamburg = punct alb).
  // API: HAFAS mgate.exe backend prin bahn.de fallback (HVV nu are HAFAS
  // public standard, ci geofox proprietary — folosim bahn.de dbnav pentru
  // rail; for bus/tram local departures cade pe bahn.de universal.
  TransitProviderConfig(
    type: TransitProviderType.hvv, api: TransitApiType.hafas,
    name: 'HVV', displayName: 'HVV (Hamburger Verkehrsverbund)',
    baseUrl: 'https://reiseauskunft.bahn.de/bin/mgate.exe',
    hafasAid: 'nlKMFa8ZY',
    hafasClientId: 'HVV', hafasClientName: 'webapp',
    hafasClientType: 'WEB', hafasVer: '1.0',
    minLat: 53.10, maxLat: 54.05, minLon: 9.40, maxLon: 11.20,
  ),
  // bodo Bodensee-Oberschwaben — Ravensburg/Friedrichshafen/Wangen
  TransitProviderConfig(
    type: TransitProviderType.bodo, api: TransitApiType.efa,
    name: 'bodo', displayName: 'bodo (Bodensee-Oberschwaben Verkehrsverbund)',
    baseUrl: 'https://efa-bw.de/nvbw',
    minLat: 47.55, maxLat: 48.30, minLon: 9.15, maxLon: 10.30,
  ),
  // RVF Freiburg — Freiburg + Emmendingen + Breisgau-Hochschwarzwald
  TransitProviderConfig(
    type: TransitProviderType.rvf, api: TransitApiType.efa,
    name: 'RVF', displayName: 'RVF (Regio-Verkehrsverbund Freiburg)',
    baseUrl: 'https://efa.rvf.de/webapp/index',
    minLat: 47.60, maxLat: 48.30, minLon: 7.55, maxLon: 8.35,
  ),
  // MDV Mitteldeutscher — Leipzig + Halle + zonele MST/NDS sud
  TransitProviderConfig(
    type: TransitProviderType.mdv, api: TransitApiType.efa,
...
class TransitService {
  ...
  static const Map<TransitProviderType, Set<String>> _providerCities = {
    // ═══════════════════════════════════════════════════════════════
    // 2026-07-13: Cataloage EXHAUSTIVE, extrase din site-urile oficiale
    // ale fiecărui verbund (26 agenți paraleli). NU date Wikipedia.
    // Total: ~2500 comune verificate.
    // ═══════════════════════════════════════════════════════════════

    // ── DING Ulm — Anhang 3 Ortsteilverzeichnis (117 comune) ──
    TransitProviderType.ding: {
      'ulm', 'neu-ulm', 'senden', 'ehingen (donau)', 'ehingen', 'biberach an der riß',
      'biberach', 'laupheim', 'illertissen', 'vöhringen', 'weißenhorn', 'riedlingen',
      'blaubeuren', 'laichingen', 'langenau', 'blaustein', 'munderkingen', 'erbach',
      'dietenheim', 'achstetten', 'alleshausen', 'allmannsweiler', 'allmendingen',
      'altenstadt', 'altheim', 'altheim/alb', 'amstetten', 'asselfingen', 'attenweiler',
      'bad buchau', 'bad schussenried', 'ballendorf', 'balzheim', 'beimerstetten',
      'bellenberg', 'berghülen', 'berkheim', 'bernstadt', 'betzenweiler', 'börslingen',
      'breitingen', 'buch', 'burgrieden', 'dettingen an der iller', 'dornstadt',
      'dürmentingen', 'dürnau', 'eberhardzell', 'elchingen', 'emeringen', 'emerkingen',
      'erlenmoos', 'erolzheim', 'ertingen', 'griesingen', 'grundsheim',
      'gutenzell-hürbel', 'heroldstatt', 'hochdorf', 'holzheim', 'holzkirch',
      'hüttisheim', 'illerkirchberg', 'illerrieden', 'ingoldingen', 'kanzach',
      'kellmünz an der iller', 'kirchberg an der iller', 'kirchdorf an der iller',
      'lauterach', 'lonsee', 'maselheim', 'merklingen', 'mietingen', 'mittelbiberach',
      'moosburg', 'nellingen', 'neenstetten', 'nerenstetten', 'nersingen',
      'oberdischingen', 'obermarchtal', 'oberroth', 'oberstadion', 'ochsenhausen',
      'oggelshausen', 'öllingen', 'oepfingen', 'osterberg', 'pfaffenhofen an der roth',
      'rammingen', 'rechtenstein', 'roggenburg', 'rot an der rot', 'rottenacker',
      'schelklingen', 'schemmerhofen', 'schnürpflingen', 'schwendi', 'seekirch',
      'setzingen', 'staig', 'steinhausen an der rottum', 'tannheim', 'tiefenbach',
      'ummendorf', 'unlingen', 'untermarchtal', 'unterroth', 'unterstadion',
      'unterwachingen', 'uttenweiler', 'wain', 'warthausen', 'weidenstetten',
      'westerheim', 'westerstetten',
      'landkreis alb-donau-kreis', 'alb-donau-kreis', 'landkreis biberach',
      'landkreis neu-ulm',
    },
    // ── MVV München — MVV-Gemeinschaftstarif 2026 (~410 comune) ──
    TransitProviderType.mvv: {
      'münchen', 'landshut', 'rosenheim', 'freising', 'dachau', 'germering',
      'fürstenfeldbruck', 'erding', 'unterschleißheim', 'olching', 'puchheim',
      'garching bei münchen', 'starnberg', 'wolfratshausen', 'bad tölz',
      'ebersberg', 'miesbach', 'mühldorf am inn', 'landsberg am lech',
      'weilheim in oberbayern', 'garmisch-partenkirchen', 'poing', 'karlsfeld',
      'oberhaching', 'unterhaching', 'ottobrunn', 'gräfelfing', 'planegg',
      'taufkirchen', 'aschheim', 'aying', 'baierbrunn', 'brunnthal',
      'feldkirchen', 'grasbrunn', 'grünwald', 'haar',
      'höhenkirchen-siegertsbrunn', 'hohenbrunn', 'ismaning',
      'kirchheim bei münchen', 'neubiberg', 'neuried', 'oberschleißheim',
      'pullach im isartal', 'putzbrunn', 'sauerlach', 'schäftlarn',
      'straßlach-dingharting', 'unterföhring', 'altomünster', 'bergkirchen',
      'erdweg', 'haimhausen', 'hebertshausen', 'hilgertshausen-tandern',
      'markt indersdorf', 'odelzhausen', 'petershausen',
      'pfaffenhofen a.d. glonn', 'röhrmoos', 'schwabhausen', 'sulzemoos',
      'vierkirchen', 'weichs', 'anzing', 'aßling', 'baiern', 'bruck',
      'egmating', 'emmering', 'forstinning', 'frauenneuharting', 'glonn',
      'grafing bei münchen', 'hohenlinden', 'kirchseeon', 'markt schwaben',
      'moosach', 'oberpframmern', 'pliening', 'steinhöring', 'vaterstetten',
      'zorneding', 'berglern', 'bockhorn', 'dorfen', 'eitting', 'finsing',
      'forstern', 'fraunberg', 'hohenpolding', 'inning am holz', 'isen',
      'kirchberg', 'langenpreising', 'lengdorf', 'moosinning', 'neuching',
      'oberding', 'ottenhofen', 'pastetten', 'sankt wolfgang', 'steinkirchen',
      'walpertskirchen', 'wartenberg', 'allershausen', 'attenkirchen',
      'au in der hallertau', 'eching', 'fahrenzhausen', 'gammelsdorf',
      'hallbergmoos', 'hörgertshausen', 'kranzberg', 'langenbach', 'marzling',
      'mauern', 'moosburg a.d. isar', 'nandlstadt', 'neufahrn bei freising',
      'paunzhausen', 'rudelzhausen', 'wang', 'wolfersdorf', 'zolling', 'alling',
      'althegnenberg', 'egenhofen', 'eichenau', 'grafrath', 'gröbenzell',
      'hattenhofen', 'jesenwang', 'kottgeisering', 'landsberied', 'maisach',
      'mammendorf', 'mittelstetten', 'moorenweis', 'oberschweinbach',
      'schöngeising', 'türkenfeld', 'andechs', 'berg', 'feldafing', 'gauting',
      'gilching', 'herrsching am ammersee', 'inning am ammersee', 'krailling',
      'pöcking', 'seefeld', 'tutzing', 'weßling', 'wörthsee', 'bad heilbrunn',
      'benediktbeuern', 'bichl', 'dietramszell', 'egling', 'eurasburg',
      'gaißach', 'geretsried', 'greiling', 'icking', 'jachenau',
      'kochel am see', 'königsdorf', 'lenggries', 'münsing', 'reichersbeuern',
      'sachsenkam', 'wackersberg', 'bad wiessee', 'bayrischzell', 'fischbachau',
      'gmund am tegernsee', 'hausham', 'holzkirchen', 'irschenberg', 'kreuth',
      'otterfing', 'rottach-egern', 'schliersee', 'tegernsee', 'valley',
      'waakirchen', 'warngau', 'weyarn', 'albaching', 'amerang',
      'aschau i.chiemgau', 'bad aibling', 'bad endorf', 'bad feilnbach',
      'bernau am chiemsee', 'brannenburg', 'breitbrunn am chiemsee',
      'bruckmühl', 'edling', 'eggstätt', 'eiselfing', 'feldkirchen-westerham',
      'flintsbach am inn', 'frasdorf', 'griesstätt', 'großkarolinenfeld',
      'halfing', 'kiefersfelden', 'kolbermoor', 'neubeuern', 'nußdorf am inn',
      'oberaudorf', 'pfaffing', 'prien am chiemsee', 'prutting', 'raubling',
      'riedering', 'rimsting', 'rohrdorf', 'rott am inn', 'samerberg',
      'schechen', 'söchtenau', 'soyen', 'stephanskirchen', 'tuntenhausen',
      'vogtareuth', 'wasserburg am inn', 'dießen am ammersee', 'geltendorf',
      'greifenberg', 'kaufering', 'schondorf am ammersee',
      'utting am ammersee', 'vilgertshofen', 'weil', 'windach',
      'hohenpeißenberg', 'peißenberg', 'peiting', 'penzberg', 'polling',
      'schongau', 'seeshaupt', 'sindelsdorf', 'steingaden', 'ettal',
      'grainau', 'krün', 'mittenwald', 'murnau am staffelsee', 'oberammergau',
      'oberau', 'seehausen am staffelsee', 'wallgau', 'ampfing', 'buchbach',
      'gars am inn', 'haag in oberbayern', 'kraiburg am inn', 'mettenheim',
      'schwindegg', 'waldkraiburg', 'adlkofen', 'altdorf', 'altfraunhofen',
      'bruckberg', 'ergolding', 'essenbach', 'geisenhausen',
      'neufahrn in niederbayern', 'niederaichbach', 'pfeffenhausen',
      'rottenburg a.d. laaber', 'tiefenbach', 'vilsbiburg',
    ...
    // ── VVS Stuttgart — Haltestellenverzeichnis oficial (207 comune) ──
    TransitProviderType.vvs: {
      'stuttgart', 'esslingen (n)', 'esslingen', 'esslingen am neckar', 'ludwigsburg',
      'sindelfingen', 'böblingen', 'leonberg', 'waiblingen', 'fellbach', 'göppingen',
      'filderstadt', 'kirchheim (t)', 'kirchheim (n)', 'kirchheim unter teck',
      'leinfelden-echterdingen', 'nürtingen', 'ostfildern', 'schorndorf',
      'bietigheim-bissingen', 'backnang', 'herrenberg', 'kornwestheim', 'winnenden',
      'vaihingen (e)', 'vaihingen an der enz', 'weinstadt',
      'geislingen (steige)', 'geislingen an der steige', 'remseck (n)',
      'remseck am neckar', 'ditzingen', 'eislingen (f)', 'metzingen', 'plochingen',
      'marbach (n)', 'marbach am neckar',
      'adelberg', 'affalterbach', 'aichelberg (gp)', 'aichtal', 'aichwald',
      'aidlingen', 'albershausen', 'alfdorf', 'allmersbach im tal', 'altbach',
      'altdorf (bb)', 'altdorf (es)', 'altenriet', 'altensteig', 'althengstett',
      'althütte', 'amstetten', 'aspach', 'asperg', 'auenwald', 'bad boll',
      'bad ditzenbach', 'bad liebenzell', 'bad überkingen', 'baltmannsweiler',
      'beilstein', 'bempflingen', 'benningen (n)', 'berglen', 'besigheim', 'beuren',
      'birenbach', 'bissingen an der teck (t)', 'böhmenkirch', 'bondorf',
      'bönnigheim', 'börtlingen', 'burgstetten', 'calw', 'cleebronn',
      'deckenpfronn', 'deggingen', 'deizisau', 'denkendorf', 'dettenhausen',
      'dettingen (t)', 'donzdorf', 'drackenstein', 'dürnau', 'eberdingen',
      'ebersbach (f)', 'ebhausen', 'ehningen', 'erdmannhausen', 'erkenbrechtsweiler',
      'erligheim', 'eschenbach', 'freiberg (n)', 'freudental', 'frickenhausen',
      'gammelshausen', 'gärtringen', 'gäufelden', 'gechingen', 'gemmrigheim',
      'gerlingen', 'gerstetten', 'gingen (f)', 'grafenau', 'grafenberg',
      'großbettlingen', 'großbottwar', 'großerlach', 'gruibingen', 'gschwend',
      'güglingen', 'hattenhofen', 'heimsheim', 'heiningen (gp)', 'hemmingen',
      'hessigheim', 'hildrizhausen', 'hochdorf (es)', 'hohenstadt (gp)',
      'holzgerlingen', 'holzmaden', 'ingersheim', 'jettingen', 'kaisersbach',
      'kernen (i. r.)', 'kirchberg (m)', 'kohlberg', 'köngen', 'korb',
      'korntal-münchingen', 'kuchen (f)', 'lauterstein', 'lenningen', 'leutenbach',
      'lichtenwald', 'löchgau', 'lorch', 'magstadt', 'mainhardt', 'markgröningen',
      'möglingen', 'mötzingen', 'mühlhausen im täle', 'mundelsheim', 'murr',
      'murrhardt', 'nagold', 'neckartailfingen', 'neckartenzlingen', 'neidlingen',
      'neuffen', 'neuhausen (f)', 'notzingen', 'nufringen', 'oberboihingen',
      'oberriexingen', 'oberstenfeld', 'ohmden', 'oppenweiler', 'ostelsheim',
      'ottenbach', 'owen', 'pleidelsheim', 'plüderhausen', 'rechberghausen',
      'reichenbach (f)', 'remshalden', 'renningen', 'rohrdorf (cw)', 'römerstein',
      'rottenburg am neckar (n)', 'rudersberg', 'rutesheim', 'sachsenheim',
      'salach', 'schlaitdorf', 'schlat', 'schlierbach', 'schönaich',
      'schwäbisch gmünd', 'schwaikheim', 'schwieberdingen', 'sersheim',
      'simmozheim', 'spiegelberg', 'steinenbronn', 'steinheim (m)', 'sulzbach (m)',
      'süßen', 'tamm', 'tiefenbronn', 'uhingen', 'unterensingen', 'urbach',
      'walddorfhäslach', 'waldenbuch', 'waldstetten (kr aa)', 'walheim',
      'wangen (gp)', 'wäschenbeuren', 'weil der stadt', 'weilheim (t)',
      'weil im schönbuch', 'weissach (bb)', 'weissach im tal', 'welzheim',
      'wendlingen (n)', 'wernau (n)', 'wiesensteig', 'winterbach', 'wolfschlugen',
      'wüstenrot', 'zell (a)',
      'landkreis böblingen', 'landkreis esslingen', 'landkreis ludwigsburg',
      'rems-murr-kreis', 'landkreis göppingen',
    },
    // ── KVV Karlsruhe — Ortsverzeichnis 2025 + integrare VPE 2026 (119 comune) ──
    TransitProviderType.kvv: {
      'karlsruhe', 'pforzheim', 'baden-baden', 'ettlingen', 'bretten', 'bruchsal',
      'karlsbad', 'stutensee', 'waldbronn', 'rheinstetten', 'pfinztal', 'walzbachtal',
      'weingarten', 'marxzell', 'malsch', 'waghäusel', 'philippsburg',
      'graben-neudorf', 'hambrücken', 'forst', 'ubstadt-weiher', 'bad schönborn',
      'kronau', 'östringen', 'gondelsheim', 'oberderdingen', 'kürnbach', 'sulzfeld',
      'zaisenhausen', 'kraichtal', 'karlsdorf-neuthard', 'linkenheim-hochstetten',
      'eggenstein-leopoldshafen', 'dettenheim', 'oberhausen-rheinhausen', 'rastatt',
      'gaggenau', 'kuppenheim', 'rheinmünster', 'muggensturm', 'bühl', 'bühlertal',
      'ottersweier', 'sinzheim', 'iffezheim', 'hügelsheim', 'durmersheim',
      'bischweier', 'steinmauern', 'elchesheim-illingen', 'au am rhein', 'forbach',
      'weisenbach', 'gernsbach', 'loffenau', 'ötigheim', 'lichtenau', 'birkenfeld',
      'eisingen', 'friolzheim', 'heimsheim', 'illingen', 'ispringen',
      'kämpfelbach', 'keltern', 'kieselbronn', 'knittlingen', 'königsbach-stein',
      'mönsheim', 'mühlacker', 'neuenbürg', 'neuhausen', 'neulingen',
      'niefern-öschelbronn', 'ölbronn-dürrn', 'ötisheim', 'remchingen',
      'sternenfels', 'straubenhardt', 'tiefenbronn', 'wiernsheim', 'wimsheim',
      'wurmberg', 'bad wildbad', 'calw', 'dobel', 'höfen an der enz',
      'bad herrenalb', 'freudenstadt', 'baiersbronn', 'dornstetten', 'öhringen',
      'weinsberg', 'eppingen', 'sinsheim', 'heilbronn', 'achern', 'kappelrodeck',
      'sasbach', 'sasbachwalden', 'oppenau', 'renchen', 'appenweier', 'kehl',
      'offenburg', 'ottenhöfen im schwarzwald', 'seebach', 'rheinau',
      'wörth am rhein', 'kandel', 'jockgrim', 'rheinzabern', 'hagenbach',
      'hatzenbühl', 'rülzheim', 'bellheim', 'germersheim', 'landau in der pfalz',
      'landau', 'bad bergzabern', 'annweiler', 'herxheim bei landau',
      'landkreis karlsruhe', 'landkreis rastatt', 'landkreis germersheim',
      'landkreis südliche weinstraße', 'enzkreis',
    },
    // ── naldo Neckar-Alb-Donau — Tarifwabenplan 2026 (89 comune) ──
    TransitProviderType.naldo: {
      'tübingen', 'reutlingen', 'albstadt', 'rottenburg am neckar', 'balingen',
      'metzingen', 'mössingen', 'hechingen', 'sigmaringen', 'bad saulgau',
      'bad urach', 'münsingen', 'meßstetten', 'mengen', 'pfullendorf',
      'gammertingen', 'ammerbuch', 'beuron', 'bingen', 'bisingen', 'bitz',
      'bodelshausen', 'burladingen', 'dautmergen', 'dettingen an der erms',
      'dormettingen', 'dotternhausen', 'dußlingen', 'eningen unter achalm',
      'engstingen', 'geislingen', 'gomaringen', 'grabenstetten', 'grafenberg',
      'grosselfingen', 'haigerloch', 'hausen am tann', 'hayingen', 'herbertingen',
      'hettingen', 'hirrlingen', 'hohenstein', 'hohentengen', 'hülben',
      'illmensee', 'inzigkofen', 'jungingen', 'kirchentellinsfurt', 'krauchenwies',
      'kusterdingen', 'langenenslingen', 'leibertingen', 'lichtenstein',
      'mehrstetten', 'meßkirch', 'nehren', 'neufra', 'neustetten', 'nusplingen',
      'obernheim', 'ofterdingen', 'ostrach', 'pfronstetten', 'pfullingen',
      'pliezhausen', 'rangendingen', 'ratshausen', 'riederich', 'römerstein',
      'rosenfeld', 'sankt johann', 'sauldorf', 'scheer', 'schömberg',
      'schwenningen', 'sigmaringendorf', 'sonnenbühl', 'starzach',
      'stetten am kalten markt', 'straßberg', 'trochtelfingen', 'veringenstadt',
      'walddorfhäslach', 'wald', 'wannweil', 'weilen unter den rinnen',
      'winterlingen', 'zwiefalten',
      'landkreis reutlingen', 'landkreis tübingen', 'landkreis sigmaringen',
      'zollernalbkreis',
    },
    // ── VRN Rhein-Neckar (46 comune verificate) ──
    TransitProviderType.vrn: {
      'mannheim', 'heidelberg', 'ludwigshafen am rhein', 'ludwigshafen',
      'kaiserslautern', 'worms', 'neustadt an der weinstraße', 'speyer',
      'frankenthal', 'landau', 'pirmasens', 'zweibrücken', 'weinheim', 'sinsheim',
      'schwetzingen', 'walldorf', 'wiesloch', 'bad dürkheim', 'grünstadt',
      'edenkoben', 'deidesheim', 'alzey', 'bad mergentheim', 'baiertal', 'bensheim',
      'biblis', 'buchen', 'bürstadt', 'dielheim', 'eberbach', 'edingen-neckarhausen',
      'frauenweiler', 'herxheim', 'hilsbach-weiler', 'hockenheim', 'ilvesheim',
      'kusel', 'landstuhl', 'leimen', 'malsch', 'mühlhausen', 'rodalben',
      'römerberg', 'st. leon-rot', 'sandhausen', 'schatthausen', 'viernheim',
      'walldürn', 'wertheim',
      ...
      'rhein-pfalz-kreis', 'landkreis südliche weinstraße', 'landkreis südwestpfalz',
    },
    // ── VGN Nürnberg — Verbundgebiet 2026 (150 comune) ──
    TransitProviderType.vgn: {
      'nürnberg', 'fürth', 'erlangen', 'schwabach', 'ansbach', 'bamberg', 'bayreuth',
      'coburg', 'hof', 'amberg', 'weiden', 'weiden i.d.opf.', 'forchheim', 'hersbruck',
      'altdorf', 'zirndorf', 'oberasbach', 'abenberg', 'absberg', 'adelshofen',
      'allersberg', 'arberg', 'aurach', 'bad rodach', 'bad steben', 'bad windsheim',
      'baudenbach', 'bechhofen', 'bruckberg', 'buch am wald', 'burgbernheim',
      'burghaslach', 'burgoberbach', 'burgsalach', 'burk', 'cadolzburg', 'colmberg',
      'dachsbach', 'dentlein a. forst', 'dettelbach', 'diebach', 'diespeck',
      'dietenhofen', 'dietersheim', 'dinkelsbühl', 'dittenheim', 'dombühl',
      'dörfles-esbach', 'dürrwangen', 'ebermannstadt', 'ebern', 'ehingen',
      'ellingen', 'emskirchen', 'ettenstatt', 'feilitzsch', 'feuchtwangen',
      'flachslanden', 'gebsattel', 'gerhardshofen', 'gerolfingen', 'geslau',
      'gnotzheim', 'gräfenberg', 'gunzenhausen', 'hagenbüchach', 'hartmannshof',
      'haßfurt', 'haundorf', 'heidenheim', 'heilsbronn', 'helmbrechts', 'herrieden',
      'hilpoltstein', 'höttingen', 'insingen', 'ippesheim', 'ipsheim', 'kinding',
      'kronach', 'kulmbach', 'langenaltheim', 'langenfeld', 'langfurth', 'lauf',
      'lehrberg', 'leutershausen', 'lichtenau', 'lichtenfels', 'ludwigsstadt',
      'markt berolzheim', 'markt bibart', 'markt erlbach', 'markt nordheim',
      'markt taschendorf', 'marktbergel', 'marktredwitz', 'meinheim', 'merkendorf',
      'mitteleschenbach', 'mönchsroth', 'muhr am see', 'münchberg', 'münchsteinach',
      'nennslingen', 'neuendettelsau', 'neuenmarkt-wirsberg', 'neuhaus (pegnitz)',
      'neuhof a.d.zenn', 'neumarkt i.d.opf.', 'neusitz', 'neustadt a.d. aisch',
      'neustadt (waldnaab)', 'oberdachstetten', 'obernzenn', 'oberscheinfeld',
      'ohrenbach', 'ornbau', 'pappenheim', 'parsberg', 'petersaurach', 'pfofeld',
      'pleinfeld', 'polsingen', 'raitenbuch', 'roth', 'rothenburg ob der tauber',
      'röckingen', 'rügland', 'scheinfeld', 'schillingsfürst', 'schirnding',
      'schopfloch', 'selb', 'simmelsdorf-hüttenbach', 'solnhofen', 'sonneberg',
      'steinach', 'sugenheim', 'theilenhofen', 'treuchtlingen', 'uehlfeld',
      'uffenheim', 'wassertrüdingen', 'weidenbach', 'weidenberg', 'weiltingen',
      'weißenburg', 'westheim', 'wicklesgreuth', 'wilhelmsdorf', 'windsbach',
      'wolframs-eschenbach', 'feucht', 'herzogenaurach',
      'landkreis nürnberger land', 'nürnberger land', 'landkreis fürth',
      'landkreis roth', 'landkreis erlangen-höchstadt', 'landkreis forchheim',
      'landkreis ansbach', 'landkreis bamberg', 'landkreis bayreuth',
      'landkreis coburg', 'landkreis hof', 'landkreis amberg-sulzbach',
    ...
    // ── AVV Aachen (35 comune) ──
    TransitProviderType.avv: {
      'aachen', 'alsdorf', 'baesweiler', 'eschweiler', 'herzogenrath', 'monschau',
      'roetgen', 'simmerath', 'stolberg', 'würselen', 'aldenhoven', 'düren',
      'heimbach', 'hürtgenwald', 'inden', 'jülich', 'kreuzau', 'langerwehe',
      'linnich', 'merzenich', 'nideggen', 'niederzier', 'nörvenich', 'titz',
      'vettweiß', 'erkelenz', 'gangelt', 'geilenkirchen', 'heinsberg',
      'hückelhoven', 'selfkant', 'übach-palenberg', 'waldfeucht', 'wassenberg',
      'wegberg', 'städteregion aachen', 'kreis düren', 'kreis heinsberg',
    },
    // ── VRR Rhein-Ruhr — Verbundraumkarte 2026 (95 comune) ──
    TransitProviderType.vrr: {
      'düsseldorf', 'duisburg', 'essen', 'dortmund', 'bochum', 'wuppertal',
      'mönchengladbach', 'krefeld', 'oberhausen', 'hagen', 'mülheim an der ruhr',
      'solingen', 'herne', 'remscheid', 'gelsenkirchen', 'bottrop', 'neuss',
      'ratingen', 'velbert', 'recklinghausen', 'marl', 'dorsten', 'gladbeck',
      'castrop-rauxel', 'herten', 'datteln', 'oer-erkenschwick', 'witten',
      'hattingen', 'ennepetal', 'gevelsberg', 'schwelm', 'wetter (ruhr)',
      'sprockhövel', 'herdecke', 'moers', 'dinslaken', 'wesel', 'kleve', 'geldern',
      'goch', 'emmerich am rhein', 'kevelaer', 'viersen', 'willich', 'nettetal',
      'kempen', 'tönisvorst', 'dormagen', 'grevenbroich', 'meerbusch', 'kaarst',
      'korschenbroich', 'langenfeld', 'hilden', 'erkrath', 'monheim am rhein',
      'mettmann', 'haan', 'heiligenhaus', 'alpen', 'bedburg-hau', 'bergkamen',
      'breckerfeld', 'brüggen', 'grefrath', 'hamminkeln', 'holzwickede', 'hünxe',
      'issum', 'jüchen', 'kalkar', 'kamen', 'kamp-lintfort', 'kerken',
      'kranenburg', 'lünen', 'niederkrüchten', 'neukirchen-vluyn', 'rees',
      'rheinberg', 'rheurdt', 'rommerskirchen', 'schermbeck', 'schwalmtal',
      'schwerte', 'sonsbeck', 'straelen', 'uedem', 'unna', 'voerde',
      'wachtendonk', 'waltrop', 'weeze', 'wülfrath', 'xanten',
      'ruhr', 'rhein-ruhr', 'ennepe-ruhr-kreis', 'kreis kleve', 'kreis mettmann',
      'kreis recklinghausen', 'rhein-kreis neuss', 'kreis viersen', 'kreis wesel',
    },
    // ── VVO Dresden (91 comune) ──
    TransitProviderType.vvo: {
      'dresden', 'hoyerswerda', 'pirna', 'meißen', 'freital', 'radebeul', 'riesa',
      'radeberg', 'großenhain', 'kamenz', 'dippoldiswalde', 'sebnitz',
      'bischofswerda', 'coswig', 'bautzen', 'heidenau', 'dohna', 'tharandt',
      'rabenau', 'dorfhain', 'glashütte', 'altenberg',
      'bad gottleuba-berggießhübel', 'bahretal', 'liebstadt', 'müglitztal',
      'kreischa', 'bannewitz', 'hermsdorf/erzgebirge', 'klingenberg',
      'rosenthal-bielatal', 'königstein', 'bad schandau', 'neustadt in sachsen',
      'hohnstein', 'stadt wehlen', 'struppen', 'rathmannsdorf',
      'reinhardtsdorf-schöna', 'gohrisch', 'lohmen', 'stolpen',
      'dürrröhrsdorf-dittersbach', 'weinböhla', 'radeburg', 'moritzburg',
      'niederau', 'diera-zehren', 'priestewitz', 'glaubitz', 'gröditz', 'zeithain',
      'nünchritz', 'strehla', 'stauchitz', 'lommatzsch', 'käbschütztal', 'nossen',
      'klipphausen', 'wilsdruff', 'lampertswalde', 'ebersbach', 'thiendorf',
      'hirschstein', 'schönfeld', 'pulsnitz', 'königsbrück', 'schwepnitz',
      'ohorn', 'großröhrsdorf', 'großharthau', 'bretnig-hauswalde',
      'ottendorf-okrilla', 'arnsdorf', 'lichtenberg', 'wachau', 'lauta',
      'bernsdorf', 'königswartha', 'panschwitz-kuckau', 'crostwitz',
    ...
    TransitProviderType.saarvv: {
      'saarland', 'saarbrücken', 'saarbrucken', 'saarlouis', 'st. wendel',
      'st. ingbert', 'sankt ingbert', 'sankt wendel',
      'beckingen', 'bexbach', 'blieskastel', 'bous', 'dillingen', 'ensdorf',
      'eppelborn', 'freisen', 'friedrichsthal', 'gersheim', 'großrosseln',
      'grossrosseln', 'heusweiler', 'homburg', 'illingen', 'kirkel',
      'kleinblittersdorf', 'lebach', 'losheim am see', 'losheim', 'mandelbachtal',
      'marpingen', 'merchweiler', 'merzig', 'mettlach', 'nalbach', 'namborn',
      'neunkirchen', 'nohfelden', 'nonnweiler', 'oberthal', 'ottweiler', 'perl',
      'püttlingen', 'puettlingen', 'quierschied', 'rehlingen-siersburg',
      'riegelsberg', 'saarwellingen', 'schiffweiler', 'schmelz', 'schwalbach',
      'spiesen-elversberg', 'sulzbach', 'tholey', 'überherrn', 'ueberherrn',
      'völklingen', 'voelklingen', 'wadern', 'wadgassen', 'wallerfangen',
      'weiskirchen',
    ...
    // ── NVV Kassel (116 comune) ──
    TransitProviderType.nvv: {
      'kassel', 'bad hersfeld', 'baunatal', 'korbach', 'eschwege', 'frankenberg',
      'schwalmstadt', 'bad wildungen', 'bad arolsen', 'fritzlar', 'homberg (efze)',
      'melsungen', 'witzenhausen', 'hofgeismar', 'rotenburg a. d. fulda', 'bebra',
      'hessisch lichtenau', 'wolfhagen', 'vellmar', 'lohfelden', 'niestetal',
      'ahnatal', 'alheim', 'allendorf (eder)', 'bad emstal', 'bad karlshafen',
      'bad sooden-allendorf', 'bad zwesten', 'battenberg', 'berkatal',
      'borken', 'breitenbach', 'breuna', 'burgwald', 'calden', 'cornberg',
      'diemelsee', 'diemelstadt', 'edermünde', 'edertal', 'espenau', 'felsberg',
      'frankenau', 'friedewald', 'frielendorf', 'fuldabrück', 'fuldatal',
      'gemünden', 'gilserberg', 'grebenstein', 'großalmerode', 'gudensberg',
      'guxhagen', 'habichtswald', 'haina', 'hann. münden', 'hatzfeld', 'hauneck',
      'haunetal', 'helsa', 'heringen', 'herleshausen', 'hohenroda', 'immenhausen',
      'jesberg', 'kaufungen', 'kirchheim', 'knüllwald', 'körle', 'lichtenfels',
      'liebenau', 'ludwigsau', 'malsfeld', 'meinhard', 'meißner', 'morschen',
      'naumburg', 'nentershausen', 'neu-eichenberg', 'neuenstein', 'neuental',
      'neukirchen', 'niedenstein', 'niederaula', 'nieste', 'oberaula', 'ottrau',
      'philippsthal', 'reinhardshagen', 'reinhardswald', 'ringgau', 'ronshausen',
      'rosenthal', 'schauenburg', 'schenklengsfeld', 'schrecksbach',
      'schwarzenborn', 'söhrewald', 'sontra', 'spangenberg', 'staufenberg',
      'trendelburg', 'twistetal', 'vöhl', 'volkmarsen', 'wabern', 'waldeck',
      'waldkappel', 'wanfried', 'warburg', 'wehretal', 'weißenborn', 'wesertal',
      'wildeck', 'willingen', 'willingshausen', 'zierenberg',
      'landkreis kassel', 'landkreis hersfeld-rotenburg',
      'landkreis waldeck-frankenberg', 'schwalm-eder-kreis', 'werra-meißner-kreis',
    },
    // ── RMV Frankfurt (307 comune) ──
    TransitProviderType.rmv: {
      'frankfurt am main', 'frankfurt a.m.', 'frankfurt', 'wiesbaden', 'darmstadt',
      'offenbach', 'offenbach a.m.', 'hanau', 'fulda', 'gießen', 'marburg',
      'wetzlar', 'bad homburg v.d.höhe', 'bad homburg', 'rüsselsheim',
      'limburg a.d.lahn', 'limburg', 'aschaffenburg', 'oberursel (ts.)',
      'kronberg i.ts.', 'königstein i.ts.', 'dreieich', 'langen', 'hofheim a.ts.',
      'eschborn', 'bad vilbel', 'bad soden a.ts.', 'bad nauheim', 'bensheim',
      'koblenz', 'neuwied', 'andernach', 'mayen', 'bad ems',
      'aarbergen', 'allendorf (lda)', 'alsbach-hähnlein', 'alsfeld', 'altenstadt',
      'amöneburg', 'angelburg', 'antrifttal', 'aßlar', 'babenhausen', 'bad camberg',
      'bad endbach', 'bad könig', 'bad orb', 'bad salzschlirf', 'bad schwalbach',
      'bad soden-salmünster', 'beselich', 'bickenbach', 'biebergemünd',
      'biebertal', 'biebesheim', 'biedenkopf', 'birstein', 'bischoffen',
      'bischofsheim (gg)', 'brachttal', 'braunfels', 'brechen', 'breidenbach',
      'breitscheid', 'brensbach', 'breuberg', 'brombachtal', 'bruchköbel',
      'büdingen', 'burghaun', 'buseck', 'büttelborn', 'butzbach', 'cölbe',
      'dautphetal', 'dieburg', 'diethardt', 'dietzenbach', 'dietzhölztal',
      'diez ost', 'dillenburg', 'dipperz', 'dornburg', 'driedorf', 'eberbach',
      'ebersburg', 'ebsdorfergrund', 'echzell', 'egelsbach', 'ehrenberg (rhön)',
      'ehringshausen', 'eichenzell', 'eiterfeld', 'elbtal', 'eltville a. rh.',
      'elz', 'eppertshausen', 'eppstein', 'erbach', 'erlensee', 'erzhausen',
      'eschenburg', 'feldatal', 'fernwald', 'fischbachtal', 'flieden',
      'flörsbachtal', 'flörsheim a.m.', 'florstadt', 'fränkisch-crumbach',
      'freiensteinau', 'freigericht', 'friedberg', 'friedrichsdorf', 'fronhausen',
      'gedern', 'geisa', 'geisenheim', 'gelnhausen', 'gemünden (felda)',
      'gernsheim', 'gersfeld', 'ginsheim-gustavsburg', 'gladenbach', 'glashütten',
      'glauburg', 'grävenwiesbach', 'grebenau', 'grebenhain', 'greifenstein',
      'griesheim', 'groß-bieberau', 'großenlüder', 'groß-gerau', 'großkrotzenburg',
      'groß-umstadt', 'groß-zimmern', 'grünberg', 'gründau', 'gumpen', 'hadamar',
      'haiger', 'hainburg', 'hammersbach', 'hasselroth', 'hattersheim a.m.',
      'heidenrod', 'herborn', 'herbstein', 'heuchelheim', 'heusenstamm',
      'hilders', 'hirschhorn (neckar)', 'hirzenhain', 'hochheim a.m.',
      'höchst i.odw.', 'hofbieber', 'hohenahr', 'hohenstein', 'holzheim',
      'homberg (ohm)', 'hosenfeld', 'hundsangen', 'hünfeld', 'hünfelden',
      'hungen', 'hünstetten', 'hüttenberg', 'idstein', 'irmtraut', 'jossgrund',
      'kalbach', 'kaltenholzhausen', 'karben', 'kefenrod', 'kelkheim (ts.)',
      'kelsterbach', 'kiedrich', 'kirchhain', 'kirtorf', 'kriftel', 'künzell',
      'lahnau', 'lahntal', 'langenselbold', 'langgöns', 'laubach', 'lauterbach',
      'lautertal', 'leun', 'lich', 'liederbach a.ts.', 'limeshain', 'linden',
      'linsengericht', 'löhnberg', 'lohra', 'lollar', 'lorch', 'lützelbach',
      'mainhausen', 'maintal', 'mainz', 'mengerskirchen', 'merenberg', 'messel',
      'michelstadt', 'mittenaar', 'modautal', 'mörfelden-walldorf', 'mossautal',
      'mücke', 'mühlheim a.m.', 'mühltal', 'münchhausen', 'münster',
      'münzenberg', 'nauheim', 'neckarsteinach', 'neu-anspach', 'neuberg',
      'neuhof', 'neu-isenburg', 'neustadt (b marburg)', 'nidda', 'niddatal',
      'nidderau', 'niederdorfelden', 'niedernhausen', 'nüsttal', 'ober-mörlen',
      'ober-ramstadt', 'obertshausen', 'oberzent', 'oestrich-winkel', 'ortenberg',
      'otzberg', 'petersberg', 'pfungstadt', 'pohlheim', 'poppenhausen',
      'rabenau', 'ranstadt', 'rasdorf', 'raunheim', 'rauschenberg', 'rehe',
      'reichelsheim (wetterau)', 'reichelsheim (odw.)', 'reinheim',
      'reiskirchen', 'rennerod', 'riedstadt', 'rockenberg', 'rodenbach',
      'rödermark', 'rodgau', 'romrod', 'ronneburg', 'rosbach v.d.höhe',
      'roßdorf', 'rüdesheim a.rh.', 'runkel', 'salz (westerwald)', 'sauerthal',
      'schaafheim', 'schlangenbad', 'schlitz', 'schlüchtern', 'schmitten',
      'schöffengrund', 'schöneck', 'schotten', 'schwalbach a.ts.', 'schwalmtal',
      'seck', 'seeheim-jugenheim', 'seligenstadt', 'selters (ts.)', 'siegbach',
      'sinn', 'sinntal', 'solms', 'stadtallendorf', 'staufenberg', 'steffenberg',
      'steinau a.d.str.', 'steinbach (ts.)', 'stockstadt a. rh.',
      'sulzbach (ts.)', 'tann', 'taunusstein', 'trebur', 'ulrichstein',
      'usingen', 'villmar', 'wächtersbach', 'wackernheim', 'waldbrunn',
      'waldems', 'waldmühlen', 'waldsolms', 'walluf', 'wartenberg', 'wehrheim',
      'weilburg', 'weilmünster', 'weilrod', 'weimar', 'weinbach', 'weiterstadt',
      'wettenberg', 'wetter', 'wohratal', 'wölfersheim', 'wöllstadt', 'zornheim',
    ...
    // ── NAH.SH Schleswig-Holstein (91 comune) ──
    TransitProviderType.nahsh: {
      'schleswig-holstein', 'kiel', 'lübeck', 'flensburg', 'norderstedt',
      'neumünster', 'elmshorn', 'pinneberg', 'wedel', 'ahrensburg', 'geesthacht',
      'itzehoe', 'rendsburg', 'reinbek', 'henstedt-ulzburg', 'schleswig',
      'bad oldesloe', 'husum', 'kaltenkirchen', 'quickborn', 'heide',
      'eckernförde', 'brunsbüttel', 'eutin', 'plön', 'ratzeburg',
      'albersdorf', 'altengörs', 'aukrug', 'bad bramstedt', 'bad st. peter-ording',
      'bad schwartau', 'bad segeberg', 'beldorf', 'beringstedt', 'bredenbek',
      'büchen', 'büsum', 'dagebüll', 'damp', 'fahrenkrug', 'fehmarn',
      'friedrichskoog', 'fresenburg', 'glücksburg', 'gokels', 'grömitz',
      'hademarschen', 'harblek', 'heiligenhafen', 'hohenwestedt', 'hohwacht',
      'hörnum', 'jarrenwisch', 'jübek', 'kappeln', 'kating', 'kellenhusen',
      'kiel-oppendorf', 'laboe', 'lauenburg', 'lensahn', 'lübeck-travemünde',
      'lütjenburg', 'marne', 'niebüll', 'nordhastedt', 'nordstrand', 'nortorf',
      'oldenburg in holstein', 'osterstedt', 'puttgarden', 'reinsbüttel',
      'sandwehle', 'schönberg', 'schwedeneck', 'st. michaelisdonn', 'strande',
      'süderbrarup', 'süderdeich', 'süderlügum', 'tarp', 'tiebensee',
      'timmendorfer strand', 'tönning', 'trittau', 'wahlstedt', 'wakendorf',
      'wankendorf', 'wasbek', 'wesselburen', 'westerland', 'witzwort', 'wrist',
      'kreis dithmarschen', 'kreis herzogtum lauenburg', 'kreis nordfriesland',
    ...
    // ── INSA Sachsen-Anhalt (nu s-a extras încă — placeholder) ──
    // ── INSA Sachsen-Anhalt — Landesnetz + Marego (87 comune, insa.de PDF-uri oficiale) ──
    TransitProviderType.insa: {
      'sachsen-anhalt', 'magdeburg', 'halle (saale)', 'halle', 'dessau-roßlau',
      'dessau', 'salzwedel', 'klötze', 'gardelegen', 'stendal', 'tangermünde',
      'tangerhütte', 'osterburg', 'havelberg', 'haldensleben', 'wolmirstedt',
      'oebisfelde', 'oschersleben', 'wanzleben', 'flechtingen', 'barleben',
      'sülzetal', 'burg', 'genthin', 'möckern', 'loburg', 'ziesar', 'jerichow',
      'elbe-parey', 'staßfurt', 'bernburg', 'schönebeck', 'aschersleben',
      'calbe', 'güsten', 'könnern', 'alsleben', 'nienburg', 'barby', 'egeln',
      'bördeland', 'köthen', 'bitterfeld-wolfen', 'zerbst', 'aken',
      'raguhn-jeßnitz', 'sandersdorf-brehna', 'muldestausee', 'gräfenhainichen',
      'lutherstadt wittenberg', 'coswig', 'jessen', 'annaburg', 'zahna-elster',
      'kemberg', 'halberstadt', 'wernigerode', 'quedlinburg', 'thale',
      'blankenburg', 'ilsenburg', 'osterwieck', 'ballenstedt', 'harzgerode',
      'falkenstein/harz', 'schwanebeck', 'sangerhausen', 'lutherstadt eisleben',
      'hettstedt', 'mansfeld', 'roßla', 'allstedt', 'merseburg',
      'bad dürrenberg', 'bad lauchstädt', 'braunsbedra', 'leuna', 'schkopau',
      'landsberg', 'querfurt', 'mücheln', 'naumburg', 'weißenfels', 'zeitz',
      'hohenmölsen', 'nebra', 'freyburg', 'laucha',
      'altmarkkreis salzwedel', 'landkreis anhalt-bitterfeld',
      'landkreis börde', 'burgenlandkreis', 'landkreis harz',
      'landkreis jerichower land', 'landkreis mansfeld-südharz', 'saalekreis',
      'salzlandkreis', 'landkreis stendal', 'landkreis wittenberg',
    },
    // ── VBN Bremen/Niedersachsen — Tarifplan 2026 (86 comune) ──
    TransitProviderType.vbn: {
      'bremen', 'bremerhaven', 'oldenburg', 'delmenhorst', 'wilhelmshaven',
      'cuxhaven', 'nordenham', 'vechta', 'diepholz', 'aurich', 'emden', 'leer',
      'papenburg', 'jever', 'varel',
      'hannover', 'garbsen', 'langenhagen', 'laatzen', 'hemmingen', 'ronnenberg',
      'seelze', 'burgdorf', 'lehrte', 'wunstorf', 'braunschweig', 'wolfsburg',
      'salzgitter', 'peine', 'gifhorn', 'wolfenbüttel', 'goslar',
      'achim', 'ottersberg', 'kirchlinteln', 'langwedel', 'dörverden',
      'thedinghausen', 'blender', 'oyten', 'weyhe', 'syke', 'stuhr', 'bassum',
      'twistringen', 'barnstorf', 'wagenfeld', 'rehden', 'lemförde',
      'schwaförden', 'ehrenburg', 'siedenburg', 'kirchdorf', 'freistatt',
      'mellinghausen', 'drebber', 'barenburg', 'brake', 'elsfleth', 'berne',
      'ovelgönne', 'stadland', 'butjadingen', 'jade', 'hude', 'hatten',
      'wardenburg', 'ganderkesee', 'wildeshausen', 'harpstedt', 'großenkneten',
      'prinzhöfte', 'colnrade', 'dötlingen', 'osterholz-scharmbeck', 'lilienthal',
      'schwanewede', 'worpswede', 'ritterhude', 'grasberg', 'hambergen',
      'edewecht', 'rastede', 'bad zwischenahn', 'westerstede', 'wiefelstede',
      'apen', 'hoya', 'eystrup', 'geestland', 'schiffdorf', 'loxstedt',
      'wurster nordseeküste', 'gnarrenburg', 'rotenburg (wümme)', 'visselhövede',
      'landkreis hannover', 'region hannover', 'landkreis peine',
      'landkreis gifhorn', 'landkreis wolfenbüttel', 'landkreis helmstedt',
      'landkreis goslar', 'landkreis northeim',
    ...
    // ── VBB Berlin-Brandenburg (105 comune) ──
    TransitProviderType.vbb: {
      'berlin', 'potsdam', 'cottbus', 'frankfurt (oder)',
      'brandenburg an der havel', 'bernau bei berlin', 'eberswalde',
      'werneuchen', 'biesenthal', 'joachimsthal', 'oranienburg', 'hennigsdorf',
      'zehdenick', 'fürstenberg/havel', 'kremmen', 'gransee', 'liebenwalde',
      'rathenow', 'falkensee', 'nauen', 'premnitz', 'ketzin/havel', 'friesack',
      'rhinow', 'milower land', 'strausberg', 'seelow', 'bad freienwalde (oder)',
      'wriezen', 'altlandsberg', 'neuhardenberg', 'buckow (märkische schweiz)',
      'rüdersdorf bei berlin', 'petershagen/eggersdorf', 'neuenhagen bei berlin',
      'fredersdorf-vogelsdorf', 'fürstenwalde/spree', 'eisenhüttenstadt',
      'beeskow', 'storkow (mark)', 'erkner', 'bad saarow', 'neuruppin',
      'wittstock/dosse', 'kyritz', 'rheinsberg', 'wusterhausen/dosse',
      'lindow (mark)', 'werder (havel)', 'bad belzig', 'beelitz', 'teltow',
      'kleinmachnow', 'stahnsdorf', 'michendorf', 'brück', 'niemegk',
      'treuenbrietzen', 'ziesar', 'perleberg', 'wittenberge', 'pritzwalk',
      'bad wilsnack', 'meyenburg', 'putlitz', 'lübben (spreewald)', 'luckau',
      'königs wusterhausen', 'wildau', 'mittenwalde', 'golßen',
      'herzberg (elster)', 'bad liebenwerda', 'elsterwerda', 'finsterwalde',
      'doberlug-kirchhain', 'falkenberg/elster', 'mühlberg/elbe', 'schlieben',
      'sonnewalde', 'uebigau-wahrenbrück', 'senftenberg', 'lauchhammer',
      'lübbenau/spreewald', 'calau', 'großräschen', 'ortrand', 'ruhland',
      'vetschau/spreewald', 'forst (lausitz)', 'guben', 'spremberg', 'drebkau',
      'welzow', 'döbern', 'ludwigsfelde', 'zossen', 'luckenwalde', 'jüterbog',
      'blankenfelde-mahlow', 'trebbin', 'baruth/mark', 'dahme/mark',
      'schwedt/oder', 'prenzlau', 'templin', 'angermünde', 'lychen',
      'landkreis barnim', 'landkreis dahme-spreewald', 'landkreis elbe-elster',
      'landkreis havelland', 'landkreis märkisch-oderland', 'landkreis oberhavel',
    ...
    // ── VMS Chemnitz — Ortsverzeichnis 04/2024 (139 comune) ──
    TransitProviderType.vms: {
      'chemnitz', 'zwickau', 'plauen', 'freiberg', 'mittweida', 'annaberg-buchholz',
      'aue-bad schlema', 'aue', 'schwarzenberg/erzgeb.', 'schwarzenberg',
      'stollberg/erzgeb.', 'stollberg', 'werdau', 'crimmitschau',
      'reichenbach', 'oelsnitz/erzgeb.', 'altmittweida', 'amtsberg', 'auerbach',
      'augustusburg', 'bärenstein-königswalde', 'bernsdorf', 'bobritzsch-hilbersdorf',
      'bockau', 'börnichen/erzgeb.', 'brand-erbisdorf', 'breitenbrunn/erzgeb.',
      'burgstädt', 'burkhardtsdorf', 'callenberg', 'claußnitz', 'crinitzberg',
      'crottendorf', 'dennheritz', 'deutschneudorf', 'döbeln', 'dorfchemnitz',
      'drebach', 'ehrenfriedersdorf', 'eibenstock', 'elterlein', 'eppendorf',
      'erlau', 'flöha', 'frankenberg', 'frauenstein', 'fraureuth', 'gelenau/erzgebirge',
      'geringswalde', 'gersdorf (bei zwickau)', 'geyer', 'glauchau', 'gornau/erzgeb.',
      'gornsdorf', 'großhartmannsdorf', 'großolbersdorf', 'großrückerswalde',
      'großschirma', 'großweitzschen', 'grünhain-beierfeld', 'grünhainichen',
      'hainichen', 'halsbrücke', 'hartenstein', 'hartha', 'hartmannsdorf',
      'heidersdorf', 'hirschfeld', 'hohenstein-ernstthal', 'hohndorf', 'jahnatal',
      'jahnsdorf/erzgeb.', 'johanngeorgenstadt', 'jöhstadt', 'kirchberg',
      'königsfeld', 'königshain-wiederau', 'kriebstein', 'kurort seiffen/erzgeb.',
      'langenbernsdorf', 'langenweißbach', 'lauter-bernsbach', 'leisnig',
      'leubsdorf', 'lichtenau', 'lichtenberg/erzgeb.', 'lichtenstein/sa.',
      'lichtentanne', 'limbach-oberfrohna', 'lößnitz', 'lugau/erzgeb.',
      'lunzenau', 'marienberg', 'meerane', 'mildenau', 'mulda/sa.', 'mühlau',
      'mülsen', 'neuhausen/erzgeb.', 'neukirchen/erzgeb.', 'neukirchen/pleiße',
      'niederdorf', 'niederfrohna', 'niederwiesa', 'niederwürschnitz', 'nossen',
      'oberlungwitz', 'oberschöna', 'oberwiera', 'oberwiesenthal', 'oederan',
      'olbernhau', 'penig', 'pockau-lengefeld', 'raschau-markersbach',
      'rechenberg-bienenmühle', 'reinsberg', 'reinsdorf', 'remse', 'rochlitz',
      'rossau', 'roßwein', 'sayda', 'scheibenberg', 'schlettau', 'schneeberg',
      'schönberg', 'schönheide', 'seelitz', 'sehmatal', 'st. egidien',
      'striegistal', 'stützengrün', 'tannenberg', 'taura', 'thalheim/erzgeb.',
      'thermalbad wiesenbad', 'thum', 'waldenburg', 'waldheim', 'wechselburg',
      'weißenborn/erzgeb.', 'wildenfels', 'wilkau-haßlau', 'wolkenstein',
      'zettlitz', 'zschopau', 'zschorlau', 'zwönitz',
      'landkreis mittelsachsen', 'landkreis zwickau', 'erzgebirgskreis',
      'vogtlandkreis',
    },
    // ── VMT Thüringen — Ortsverzeichnis 08/2025 (>1000 comune, subset major) ──
    TransitProviderType.vmt: {
      ...
      'schmalkalden', 'rudolstadt', 'bad berka', 'bad blankenburg',
      'bad klosterlausnitz', 'bad kösen', 'bad köstritz', 'bad lobenstein',
      'bad sulza', 'bad tabarz', 'blankenhain', 'bürgel', 'buttstädt', 'camburg',
      'dornburg', 'friedrichroda', 'gefell', 'gehren', 'geraberg', 'goldbach',
      'gräfenthal', 'großbreitenbach', 'heilbad heiligenstadt', 'hermsdorf',
      'hildburghausen', 'hirschberg', 'kahla', 'kaltenwestheim', 'kirchheim',
      'kranichfeld', 'lauscha', 'lehesten', 'leinefelde-worbis', 'leutenberg',
      'magdala', 'martinroda', 'mellingen', 'neuhaus am rennweg', 'neustadt (orla)',
      'oberhof', 'oberweißbach', 'ohrdruf', 'orlamünde', 'pößneck', 'probstzella',
      'ranis', 'remptendorf', 'renthendorf', 'ronneburg', 'römhild', 'saalburg',
      'schleiz', 'schmiedefeld', 'schmalkalden-meiningen', 'schwarza',
      'schwarzburg', 'stadtroda', 'stadtilm', 'steinach', 'stützerbach',
      'tabarz', 'tambach-dietharz', 'tanna', 'tannroda', 'themar', 'thal',
      'triptis', 'wasungen', 'wutha-farnroda', 'zella-mehlis', 'zeulenroda',
      'ziegenrück', 'landkreis gotha', 'landkreis nordhausen',
    ...
    // ── VVW Rostock (47 comune) ──
    TransitProviderType.vvw: {
      'rostock', 'warnemünde', 'bad doberan', 'kühlungsborn', 'rerik', 'neubukow',
      'kröpelin', 'satow', 'bastorf', 'wittenbeck', 'nienhagen', 'retschow',
      'steffenshagen', 'reddelich', 'admannshagen-bargeshagen',
      'elmenhorst/lichtenhagen', 'hohenfelde', 'lambrechtshagen', 'kritzmow',
      'stäbelow', 'papendorf', 'ziesendorf', 'bröbberow', 'schwaan', 'bützow',
      'mönchhagen', 'rövershagen', 'blankenhagen', 'poppendorf', 'thulendorf',
      'bentwisch', 'broderstorf', 'roggentin', 'dummerstorf', 'kavelstorf',
      'cammin', 'selpin', 'sanitz', 'tessin', 'gnoien', 'laage', 'güstrow',
      'krakow am see', 'teterow', 'gelbensande', 'graal-müritz',
      'ribnitz-damgarten', 'dettmannsdorf',
      'landkreis rostock', 'landkreis bad doberan',
    },
    // ── VMV Mecklenburg-Vorpommern (52 comune) ──
    TransitProviderType.vmv: {
      'schwerin', 'wismar', 'greifswald', 'stralsund', 'neubrandenburg',
      'neustrelitz', 'waren', 'parchim', 'ludwigslust', 'anklam', 'demmin',
      'bergen', 'ueckermünde', 'pasewalk', 'malchin',
      'heiligendamm', 'putbus', 'binz', 'sellin', 'baabe', 'göhren',
      'lauterbach', 'lubmin', 'usedom', 'sternberg', 'grevesmühlen', 'röbel',
      'klein zicker', 'sassnitz', 'tribsees', 'blankenberg', 'weiße wiek',
      'hohen luckow', 'zarrentin', 'dömitz', 'friedland', 'feldberg', 'hagenow',
      'meyenburg', 'lübeck', 'schönberg', 'angermünde', 'bad kleinen',
      'barth', 'velgast', 'kenz', 'saatel',
    ...
    // ── VRT Trier — gesamtliniennetzkarte (~380 comune) ──
    TransitProviderType.vrt: {
      'trier', 'bitburg', 'wittlich', 'daun', 'prüm', 'saarburg', 'hermeskeil',
      'gerolstein', 'aach', 'allenbach', 'alsdorf', 'arzfeld', 'auw',
      'baasem', 'badem', 'baldringen', 'basberg', 'bauler', 'baustert',
      'beilingen', 'bekond', 'bengel', 'bereborn', 'berglicht', 'bergweiler',
      'bernkastel-kues', 'bescheid', 'bettenfeld', 'bettingen', 'beuren',
      'bewingen', 'bickendorf', 'biersdorf', 'binsfeld', 'birgel', 'birresborn',
      'bischofsdhron', 'bleckhausen', 'bleialf', 'bodenbach', 'bollendorf',
      'bombogen', 'bonerath', 'bongard', 'boos', 'borler', 'boxberg',
      'brandscheid', 'brauneberg', 'brecht', 'briedel', 'brimingen',
      'brockscheid', 'bruch', 'brücktal', 'buchet', 'büdesheim', 'burg',
      'butzweiler', 'dackscheid', 'dahlem', 'dahnen', 'daleiden', 'damflos',
      'darscheid', 'dasburg', 'daufenbach', 'demerath', 'densborn', 'detzem',
      'deudesfeld', 'deuselbach', 'dhronecken', 'dingdorf', 'dockendorf',
      'dockweiler', 'dodenburg', 'dorf', 'drees', 'dreis', 'dudeldorf',
      'duppach', 'echtershausen', 'eckfeld', 'ehlenz', 'ehrang', 'eilscheid',
      'eisenschmitt', 'ellscheid', 'ellwerath', 'enkirch', 'ensch', 'erden',
      'ernzen', 'esch', 'eschfeld', 'etteldorf', 'euren', 'farschweiler',
      'feilsdorf', 'fell', 'ferschweiler', 'feuerscheid', 'feusdorf', 'filzen',
      'fisch', 'fleringen', 'fließem', 'föhren', 'franzenheim', 'freudenburg',
      'gees', 'geichlingen', 'gentingen', 'gillenfeld', 'gilzem', 'gindorf',
      'gipperath', 'gladbach', 'gönnersdorf', 'gonzerath', 'gornhausen',
      'graach', 'gransdorf', 'greimerath', 'greverath', 'großlangenfeld',
      'großlittgen', 'gunderath', 'gusenburg', 'gusterath', 'gutweiler',
      'habscheid', 'halsdorf', 'hallschlag', 'hargarten', 'hasborn',
      'heckenmünster', 'heckhuscheid', 'heddert', 'heidenburg', 'heidweiler',
      'heilbach', 'heilenbach', 'heinzerath', 'heisdorf', 'hentern', 'herforst',
      'herl', 'hersdorf', 'hetzerath', 'hillesheim', 'hinzenburg',
      'hinzert-pölert', 'hirschfeld', 'hisel', 'höchstberg', 'hochscheid',
      'hockweiler', 'holsthum', 'holzerath', 'hontheim', 'horath', 'horperath',
      'hosten', 'hoxel', 'hundheim', 'hupperath', 'hüttingen', 'idenheim',
      'idesheim', 'igel', 'immerath', 'immert', 'ingendorf', 'irrel',
      'irrhausen', 'irsch', 'jucken', 'jünkerath', 'kanzem', 'kaperich',
      'karlshausen', 'kaschenbach', 'kasel', 'kastel-staadt', 'kelberg',
      'kell am see', 'kenn', 'kerpen', 'kerschenbach', 'kesfeld', 'kesten',
      'kickeshausen', 'kinderbeuern', 'kinheim', 'kirf', 'kirsbach', 'klausen',
      'kleinich', 'kleinlangenfeld', 'klüsserath', 'kollesleuken', 'kolverath',
      'konz', 'kordel', 'körperich', 'korlingen', 'körrig', 'köttelbach',
      'kötterichen', 'kövenig', 'köwerich', 'koxhausen', 'kradenbach', 'kröv',
      'kruchten', 'kyllburg', 'kyllburgweiler', 'lampaden', 'landscheid',
      'langenfeld', 'langsur', 'lasel', 'laudesfeld', 'laufeld', 'lehnerath',
      ...
      'müllenbach', 'mürlenbach', 'musweiler', 'muxerath', 'nasingen',
      'naurath', 'neichen', 'nerdlen', 'neroth', 'neuerburg', 'neuheilen',
      'neuhütten', 'neumagen-dhron', 'newel', 'niederkail',
      'niederscheidweiler', 'niederweiler', 'niederweis', 'niehl', 'niersbach',
      'nimshuscheid', 'nimsreuland', 'nittel', 'noviand', 'nusbaum',
      'oberbillig', 'oberehe', 'oberelz', 'oberemmel', 'oberkail',
      'oberlascheid', 'oberlauch', 'oberöfflingen', 'oberraden',
      'oberscheidweiler', 'obersgegen', 'oberüttfeld', 'oberweis', 'oberzerf',
      'ockfen', 'olkenbach', 'ollmuth', 'olmscheid', 'olsdorf', 'olzheim',
      'onsdorf', 'orenhofen', 'ormont', 'orsfeld', 'osann-monzel', 'osburg',
      'palzem', 'pantenburg', 'panzweiler', 'peffingen', 'pellingen', 'pelm',
      'pfalzel', 'philippsheim', 'philippsweiler', 'pickließem', 'piesport',
      'platten', 'plein', 'plütscheid', 'pluwig', 'pölich', 'preischeid',
      'preist', 'pronsfeld', 'prosterath', 'pünderich', 'pützborn', 'quint',
      'ralingen', 'rapperath', 'rascheid', 'reil', 'reimerath', 'reinsfeld',
      'rengen', 'retterath', 'riedenburg', 'ringhuscheid', 'riol', 'rittersdorf',
      'rivenich', 'riveris', 'rockeskyll', 'rommersheim', 'roscheid',
      'roth bei prüm', 'ruwer', 'salm', 'salmtal', 'sarmersbach', 'sassen',
      'saxler', 'schalkenmehren', 'scheid', 'schillingen', 'schleid',
      'schoden', 'schöndorf', 'schönecken', 'schüller', 'schwarzenborn',
      'schweich', 'seffern', 'sehlem', 'seinsfeld', 'sellerich', 'serrig',
      'sevenig', 'sinspelt', 'sirzenich', 'spangdahlem', 'speicher',
      'stadtkyll', 'staffel', 'steffeln', 'steinborn', 'steineberg',
      'steiningen', 'stockem', 'stroheich', 'strohn', 'sülm', 'taben-rodt',
      'tawern', 'temmels', 'thalfang', 'thomm', 'thörnich', 'trassem',
      'traben-trarbach', 'trierweiler', 'trittenheim', 'üdersdorf', 'udler',
      'uersfeld', 'ueß', 'ulmen', 'ürzig', 'üttfeld', 'utscheid', 'utzerath',
      'üxheim', 'veldenz', 'vierherrenborn', 'waldkönigen', 'waldrach',
      'wallenborn', 'wallendorf', 'wallersheim', 'wallscheid', 'walsdorf',
      'wasserliesch', 'watzerath', 'wawern', 'waxweiler', 'wecker', 'wederath',
      'wehlen', 'weidenbach', 'weidingen', 'weinsheim', 'weißenseifen',
      'weiperath', 'welcherath', 'wellen', 'welschbillig', 'wengerohr',
      'wettlingen', 'wiersdorf', 'wiesbaum', 'willwerath', 'wilsecker',
      'wiltingen', 'wincheringen', 'winterspelt', 'wintrich', 'wißmannsdorf',
      'wolsfeld', 'zeltingen-rachtig', 'zemmer', 'zerf', 'zewen', 'züsch',
      'landkreis trier-saarburg', 'eifelkreis bitburg-prüm',
      'landkreis bernkastel-wittlich', 'landkreis vulkaneifel',
    },
    // ── VRS Köln/Bonn (53 comune) ──
    TransitProviderType.vrs: {
      'köln', 'koeln', 'bonn', 'leverkusen', 'bedburg', 'bergheim', 'brühl',
      'elsdorf', 'erftstadt', 'frechen', 'hürth', 'kerpen', 'pulheim',
      'wesseling', 'alfter', 'bad honnef', 'bornheim', 'eitorf', 'hennef',
      'königswinter', 'lohmar', 'meckenheim', 'much', 'neunkirchen-seelscheid',
      'niederkassel', 'rheinbach', 'ruppichteroth', 'sankt augustin', 'siegburg',
      'swisttal', 'troisdorf', 'wachtberg', 'windeck', 'bergisch gladbach',
      'burscheid', 'kürten', 'leichlingen', 'odenthal', 'overath', 'rösrath',
      'wermelskirchen', 'bergneustadt', 'engelskirchen', 'gummersbach',
      'hückeswagen', 'lindlar', 'marienheide', 'morsbach', 'nümbrecht',
      'radevormwald', 'reichshof', 'waldbröl', 'wiehl', 'wipperfürth',
      'rhein-sieg-kreis', 'rhein-erft-kreis', 'rheinisch-bergischer kreis',
      'oberbergischer kreis', 'kreis euskirchen',
    },
    // ── WTP = WestfalenTarif (55 comune) ──
    TransitProviderType.wtp: {
      'münster', 'bielefeld', 'hamm', 'paderborn', 'detmold', 'gütersloh',
      'herford', 'iserlohn', 'lippstadt', 'minden', 'rheine', 'siegen', 'ahlen',
      'ibbenbüren', 'bünde', 'bad salzuflen', 'lemgo', 'höxter',
      'horn-bad meinberg', 'bad driburg', 'willebadessen', 'borken', 'raesfeld',
      'velen', 'tecklenburg', 'brilon', 'medebach', 'hallenberg', 'winterberg',
      'willingen (upland)', 'schlangen', 'dortmund', 'hagen', 'witten', 'wetter',
      'herdecke', 'datteln', 'oer-erkenschwick', 'waltrop', 'schwelm',
      'ennepetal', 'gevelsberg', 'breckerfeld', 'osnabrück', 'melle',
      'bissendorf', 'hasbergen', 'hagen a.t.w.', 'bad iburg', 'glandorf',
      'bad laer', 'georgsmarienhütte', 'hilter a.t.w.', 'dissen',
      'bad rothenfelde',
    ...
    // ── VOS Osnabrück (19 comune) ──
    TransitProviderType.vos: {
      'osnabrück', 'ankum', 'quakenbrück', 'fürstenau', 'bramsche', 'bohmte',
      'bad essen', 'ostercappeln', 'melle', 'bissendorf', 'georgsmarienhütte',
      'bad laer', 'hagen a.t.w.', 'hasbergen', 'bad rothenfelde', 'bad iburg',
      'hilter a.t.w.', 'dissen a.t.w.', 'wallenhorst', 'landkreis osnabrück',
    },
    // ── DEFAS Bayern — Bayernweit aggregator (39 orașe) ──
    TransitProviderType.defasBayern: {
      'würzburg', 'schweinfurt', 'aschaffenburg', 'bad kissingen', 'kitzingen',
      'lohr am main', 'miltenberg', 'hassfurt', 'haßfurt', 'bad neustadt',
      ...
      'schwandorf', 'cham', 'tirschenreuth', 'roding', 'furth im wald',
      'kelheim', 'neumarkt in der oberpfalz', 'sulzbach-rosenberg',
      'landkreis regensburg', 'landkreis cham', 'landkreis schwandorf',
      'landkreis neumarkt in der oberpfalz', 'landkreis amberg-sulzbach',
      'passau', 'landshut', 'deggendorf', 'straubing', 'landau', 'dingolfing',
      'freyung', 'grafenau', 'regen', 'zwiesel', 'pfarrkirchen', 'eggenfelden',
      'simbach am inn', 'vilshofen an der donau',
      ...
      'füssen', 'oberstdorf', 'bad wörishofen', 'marktoberdorf', 'mindelheim',
      'illertissen', 'donauwörth', 'nördlingen',
      'landkreis oberallgäu', 'landkreis unterallgäu', 'landkreis ostallgäu',
      'landkreis lindau', 'landkreis günzburg',
      'landkreis dillingen an der donau',
      'rosenheim', 'traunstein', 'berchtesgaden', 'bad reichenhall',
      'garmisch-partenkirchen', 'mühldorf', 'burghausen', 'weilheim', 'bad tölz',
      'landkreis rosenheim', 'landkreis traunstein',
      'landkreis mühldorf am inn', 'landkreis berchtesgadener land',
      'landkreis altötting', 'landkreis garmisch-partenkirchen',
      'landkreis weilheim-schongau', 'landkreis bad tölz-wolfratshausen',
      'landkreis miesbach', 'landkreis eichstätt',
      'ingolstadt', 'landkreis ingolstadt',
    },
    // ── AVV Augsburg (85 comune) ──
    TransitProviderType.avvAugsburg: {
      'augsburg', 'aichach', 'friedberg', 'mering', 'kissing', 'dasing',
      'affing', 'aindling', 'inchenhofen', 'kühbach', 'pöttmes', 'sielenbach',
      'schiltberg', 'adelzhausen', 'obergriesbach', 'petersdorf', 'rehling',
      'todtenweis', 'merching', 'schmiechen', 'hollenbach', 'eurasburg', 'baar',
      'ried', 'steindorf am ammersee', 'dillingen an der donau', 'lauingen',
      'gundelfingen an der donau', 'höchstädt an der donau', 'wertingen',
      'buttenwiesen', 'laugna', 'villenbach', 'zusamaltheim', 'syrgenstein',
      'bissingen', 'holzheim', 'schwenningen', 'mödingen', 'glött', 'finningen',
      'haunsheim', 'bächingen an der brenz', 'medlingen', 'ziertheim',
      'donauwörth', 'schwabmünchen', 'königsbrunn', 'bobingen', 'gersthofen',
      'neusäß', 'stadtbergen', 'diedorf', 'dinkelscherben', 'gessertshausen',
      'zusmarshausen', 'meitingen', 'langweid am lech', 'thierhaupten', 'welden',
      'altenmünster', 'emersacker', 'adelsried', 'aystetten', 'biberbach',
      'horgau', 'fischach', 'mickhausen', 'langenneufnach', 'mittelneufnach',
      'walkertshofen', 'scherstetten', 'langerringen', 'großaitingen',
      'kleinaitingen', 'untermeitingen', 'obermeitingen', 'klosterlechfeld',
      'graben', 'wehringen', 'hiltenfingen', 'oberottmarshausen', 'gablingen',
      'ellgau', 'nordendorf', 'allmannsweiler', 'kühlenthal', 'westendorf',
      'ehingen am ries', 'bonstetten', 'ustersbach', 'hausen', 'heretsried',
      'landkreis augsburg', 'landkreis aichach-friedberg',
      'landkreis dillingen',
    },
    // ── VVE = VVV Vogtland (36 comune) ──
    TransitProviderType.vve: {
      'plauen', 'auerbach', 'reichenbach', 'oelsnitz', 'klingenthal',
      'markneukirchen', 'falkenstein', 'rodewisch', 'treuen', 'adorf',
      'bad brambach', 'bad elster', 'bergen', 'bösenbrunn', 'eichigt',
      'ellefeld', 'elsterberg', 'grünbach', 'hammerbrücke', 'heinsdorfergrund',
      'lengenfeld', 'limbach', 'mehltheuer', 'muldenhammer', 'mühltroff',
      'mylau', 'netzschkau', 'neuensalz', 'neustadt', 'pausa', 'schöneck',
      'theuma', 'tirpersdorf', 'triebel', 'weischlitz', 'werda',
      'vogtlandkreis', 'landkreis vogtland',
    },
    // ── HVV Hamburg — Tarifplan geografisch A-H (185 comune) ──
    TransitProviderType.hvv: {
      'hamburg', 'altona', 'bergedorf', 'harburg', 'norderstedt', 'wedel',
      'pinneberg', 'elmshorn', 'quickborn', 'halstenbek', 'rellingen',
      'schenefeld', 'uetersen', 'tornesch', 'barmstedt', 'hasloh', 'bilsen',
      'ellerau', 'holm', 'moorrege', 'bönningstedt', 'appen', 'bad bramstedt',
      'kaltenkirchen', 'henstedt-ulzburg', 'bad segeberg', 'wahlstedt',
      'bornhöved', 'rickling', 'boostedt', 'leezen', 'sülfeld', 'hartenholm',
      'hasenmoor', 'lentföhrden', 'kisdorf', 'willingrade', 'schlamersdorf',
      'altengörs', 'bad oldesloe', 'ahrensburg', 'bargteheide', 'reinbek',
      'glinde', 'barsbüttel', 'trittau', 'reinfeld', 'lütjensee', 'hoisdorf',
      'ammersbek', 'tangstedt', 'zarpen', 'travenbrück', 'elmenhorst',
      'großensee', 'oststeinbek', 'ratzeburg', 'mölln', 'geesthacht',
      'schwarzenbek', 'lauenburg', 'büchen', 'wentorf', 'aumühle', 'wohltorf',
      'dassendorf', 'breitenfelde', 'berkenthin', 'krummesse', 'gudow',
      'nusse', 'seedorf', 'duvensee', 'mustin', 'koberg', 'kastorf', 'linau',
      'hornbek', 'müssen', 'talkau', 'labenz', 'güster', 'winsen', 'buchholz',
      'seevetal', 'stelle', 'tostedt', 'jesteburg', 'hanstedt', 'hollenstedt',
      'neu wulmstorf', 'rosengarten', 'handeloh', 'undeloh', 'egestorf',
      'marschacht', 'drage', 'tespe', 'wulfsen', 'toppenstedt', 'bendestorf',
      'moisburg', 'wistedt', 'welle', 'stade', 'buxtehude', 'jork',
      'horneburg', 'apensen', 'fredenbeck', 'ahlerstedt', 'drochtersen',
      'wischhafen', 'hammah', 'oldendorf', 'dollern', 'beckdorf',
      'hollern-twielenfleth', 'freiburg', 'lüneburg', 'bardowick', 'adendorf',
      'amelinghausen', 'bleckede', 'dahlenburg', 'neetze', 'scharnebeck',
      'embsen', 'melbeck', 'reppenstedt', 'brietlingen', 'barnstedt',
      'vastorf', 'wittorf', 'cuxhaven', 'otterndorf', 'cadenberge', 'hemmoor',
      'lamstedt', 'hechthausen', 'wingst', 'beverstedt', 'loxstedt',
      'schiffdorf', 'bad bederkesa', 'uelzen', 'bad bevensen', 'bienenbüttel',
      'suderburg', 'ebstorf', 'bad bodenteich', 'rosche', 'wieren',
      'unterlüß', 'gerdau', 'soltendieck', 'suhlendorf', 'himbergen',
      'dannenberg', 'lüchow', 'hitzacker', 'wustrow', 'clenze', 'schnega',
      'zernien', 'soltau', 'schneverdingen', 'bispingen', 'munster',
      'bad fallingbostel', 'walsrode', 'wietzendorf', 'faßberg', 'dorfmark',
      'wolterdingen', 'wintermoor', 'rotenburg', 'scheeßel', 'visselhövede',
      'sittensen', 'zeven', 'heeslingen', 'selsingen', 'gnarrenburg',
      'sottrum', 'tarmstedt', 'fintel', 'kirchtimke', 'kirchwalsede',
      'lauenbrück', 'itzehoe', 'wilster', 'glückstadt', 'krempe',
      'kellinghusen', 'lägerdorf', 'wrist', 'horst', 'brokstedt', 'dauenhof',
    },
    // ── bodo Bodensee-Oberschwaben — Anlage 4 Ortsverzeichnis 2026 (93 comune) ──
    TransitProviderType.bodo: {
      'ravensburg', 'friedrichshafen', 'weingarten', 'wangen', 'leutkirch',
      'lindau', 'meckenbeuren', 'meersburg', 'markdorf', 'tettnang',
      'überlingen', 'aulendorf', 'bad saulgau', 'bad schussenried',
      'bad waldsee', 'bad wurzach', 'achberg', 'aichstetten', 'aitrach',
      'altshausen', 'amtzell', 'argenbühl', 'baienfurt', 'baindt', 'berg',
      'bergatreute', 'bermatingen', 'bodnegg', 'bodolz', 'boms', 'daisendorf',
      'deggenhausertal', 'ebenweiler', 'ebersbach-musbach', 'eichstegen',
      'eriskirch', 'fleischwangen', 'frickingen', 'fronreute', 'gestratz',
      'grünenbach', 'grünkraut', 'guggenhausen', 'hagnau', 'heiligenberg',
      'heimenkirch', 'herdwangen-schönach', 'hergatz', 'hergensweiler',
      'horgenzell', 'hoßkirch', 'illmensee', 'immenstaad', 'isny', 'kißlegg',
      'kressbronn', 'königseggwald', 'langenargen', 'lindenberg', 'maierhöfen',
      'neukirch', 'nonnenhorn', 'oberreute', 'oberstaufen', 'oberteuringen',
      'opfenbach', 'ostrach', 'owingen', 'pfullendorf', 'riedhausen',
      'rot an der rot', 'röthenbach', 'salem', 'scheidegg', 'schlier',
      'sigmarszell', 'sipplingen', 'stetten', 'stiefenhofen',
      'uhldingen-mühlhofen', 'unterwaldhausen', 'vogt', 'wald', 'waldburg',
      'wasserburg', 'weiler-simmerberg', 'weißensberg', 'wilhelmsdorf',
      'wolfegg', 'wolpertswende',
      'landkreis ravensburg', 'bodenseekreis', 'landkreis lindau',
    },
    // ── RVF Freiburg — Regio-Verkehrsverbund (~90 comune) ──
    TransitProviderType.rvf: {
      'freiburg', 'freiburg im breisgau', 'emmendingen', 'waldkirch',
      'endingen am kaiserstuhl', 'kenzingen', 'herbolzheim', 'elzach',
      'bad krozingen', 'staufen', 'müllheim', 'breisach am rhein',
      'gundelfingen', 'denzlingen', 'kirchzarten', 'stegen', 'oberried',
      'hinterzarten', 'titisee-neustadt', 'löffingen', 'st. blasien',
      'todtnau', 'schluchsee', 'lenzkirch', 'feldberg', 'ihringen', 'merdingen',
      'sasbach am kaiserstuhl', 'vogtsburg im kaiserstuhl', 'sölden',
      'ehrenkirchen', 'bötzingen', 'buggingen', 'eschbach', 'sulzburg',
    ...
    TransitProviderType.mdv: {
      'leipzig', 'halle (saale)', 'halle', 'markkleeberg', 'schkeuditz',
      'delitzsch', 'grimma', 'wurzen', 'borna', 'oschatz', 'torgau',
      'eilenburg', 'dessau-roßlau', 'dessau', 'wittenberg',
      'lutherstadt wittenberg', 'köthen', 'bitterfeld-wolfen', 'zeitz',
      'weißenfels', 'naumburg', 'merseburg', 'altenburg', 'schmölln',
      'meuselwitz', 'gößnitz', 'brandis', 'colditz', 'geithain', 'groitzsch',
      'kitzscher', 'markranstädt', 'naunhof', 'pegau', 'rötha', 'trebsen',
      'zwenkau', 'bad lausick', 'bad düben', 'jesewitz', 'krostitz',
      'löbnitz', 'rackwitz', 'schkopau', 'landsberg', 'braunsbedra',
      'bad dürrenberg', 'leuna', 'querfurt', 'lützen', 'teuchern',
      'hohenmölsen', 'wetterzeube', 'droyßig', 'osterfeld', 'gutenborn',
      'elsteraue', 'kayna', 'meineweh', 'nebra', 'freyburg', 'goseck',
      'karsdorf', 'gleina', 'balgstädt', 'mücheln', 'geiseltal', 'wanzleben',
      'coswig', 'roßlau', 'oranienbaum-wörlitz',
      'landkreis leipzig', 'landkreis nordsachsen', 'saalekreis',
      'burgenlandkreis', 'landkreis wittenberg', 'landkreis anhalt-bitterfeld',
      'altenburger land',
    },
  };
  ...
  Future<TripRoute> _efaTripRoute(TransitProviderConfig p, Departure dep) async {
    ...
    // 2026-07-13 FIX BUG: DM returneaza dep.line = "RS 51" (cu prefix+spatiu)
    // dar trip returneaza mode.number = "51" (doar numar).
    // Match strict `lineNum != dep.line && !lineNum.contains(dep.line)`
    // esua → 0 stops la bus/tram multi (STR 1, SB 12, RS 51, N1 etc.).
    // Fix multi-strat + fallback graceful la primul non-walk leg.
