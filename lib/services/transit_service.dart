...
class TransitService {
  ...
  static const Map<TransitProviderType, Set<String>> _providerCities = {
    ...
    TransitProviderType.nahsh: {
      ...
      'eckernförde', 'brunsbüttel', 'eutin', 'plön', 'ratzeburg', 'ahrensburg',
    ...
    TransitProviderType.insa: {
      ...
      'dessau', 'stendal', 'weißenfels', 'halberstadt', 'bitterfeld-wolfen',
      'bitterfeld', 'merseburg', 'wernigerode', 'naumburg (saale)', 'naumburg',
      'bernburg (saale)', 'bernburg', 'schönebeck (elbe)', 'schönebeck', 'zeitz',
      'sangerhausen', 'zerbst/anhalt', 'zerbst', 'aschersleben', 'staßfurt',
      'quedlinburg', 'haldensleben', 'oschersleben', 'thale', 'wittenberg',
    ...
    TransitProviderType.bodo: {
      ...
      'sigmarszell', 'sipplingen', 'stetten', 'stiefenhofen', 'tettnang',
