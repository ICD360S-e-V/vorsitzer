...
-----END CERTIFICATE-----''';
  ...
  /// Creates an HttpClient with certificate pinning (release) or default (debug).
  ...
  /// Creates an HttpClient without pinning (for external APIs like handelsregister.de).
