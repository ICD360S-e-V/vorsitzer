...
List<Map<String, dynamic>> blutParameterListe(bool maennlich) {
  ...
  return [
    ...
    {'key': 'mch', 'label': 'MCH', 'unit': 'pg', 'min': 27.0, 'max': 33.0, 'gruppe': 'Blutbild', 'such': 'HbE Kleines Blutbild MCH'},
    {'key': 'mchc', 'label': 'MCHC', 'unit': 'g/dl', 'min': 32.0, 'max': 36.0, 'gruppe': 'Blutbild', 'such': 'Kleines Blutbild MCHC'},
    {'key': 'mcv', 'label': 'MCV', 'unit': 'fl', 'min': 80.0, 'max': 100.0, 'gruppe': 'Blutbild', 'such': 'Kleines Blutbild MCV'},
    ...
    {'key': 'crp', 'label': 'C-reaktives Protein (CRP)', 'unit': 'mg/l', 'min': 0.0, 'max': 5.0, 'gruppe': 'Entzündung', 'such': 'C-reaktives Protein C-reaktives Protein (CRP) CRP Entzündungswerte'},
    ...
    {'key': 'bilirubin_direkt', 'label': 'Bilirubin direkt', 'unit': 'mg/dl', 'min': 0.0, 'max': 0.3, 'gruppe': 'Leberwerte', 'such': 'Bili dir. Bilirubin direkt Leberwerte'},
    ...
    {'key': 'bilirubin_indirekt', 'label': 'Bilirubin indirekt', 'unit': 'mg/dl', 'min': 0.0, 'max': 0.8, 'gruppe': 'Leberwerte', 'such': 'Bili indir. Bilirubin indirekt Leberwerte'},
    ...
    // ── Nierenwerte ──
    {'key': 'ckd_epi', 'label': 'CKD-EPI Kreatinin (eGFR)', 'unit': 'ml/min', 'min': 90.0, 'max': 999.0, 'gruppe': 'Nierenwerte', 'such': 'CKD-EPI Kreatinin CKD-EPI Kreatinin (eGFR) GFR Nierenwerte eGFR'},
    {'key': 'creatinin', 'label': 'Creatinin (Serum)', 'unit': 'mg/dl', 'min': m ? 0.7 : 0.5, 'max': m ? 1.2 : 0.9, 'gruppe': 'Nierenwerte', 'such': 'Crea Creatinin Creatinin (Serum) Krea Nierenwerte Serum'},
    ...
    // ── Vitamine ──
    {'key': 'folsaeure', 'label': 'Folsäure', 'unit': 'ng/ml', 'min': 3.0, 'max': 17.0, 'gruppe': 'Vitamine', 'such': 'Folat Folsäure Vitamine'},
    ...
    {'key': 'vitamin_b12', 'label': 'Vitamin B12', 'unit': 'pg/ml', 'min': 200.0, 'max': 900.0, 'gruppe': 'Vitamine', 'such': 'B12 Vitamin B12 Vitamine'},
    ...
    {'key': 'vitamin_d3', 'label': 'Vitamin D3 (25-OH)', 'unit': 'ng/ml', 'min': 30.0, 'max': 100.0, 'gruppe': 'Vitamine', 'such': '25-OH 25-OH-D3 Calcidiol Vitamin D3 Vitamin D3 (25-OH) Vitamine'},
    ...
    {'key': 'hepatitis_b_c_igg', 'label': 'Hepatitis B c IgG (Anti-HBc)', 'unit': 'S/CO', 'min': 0.0, 'max': 0.99, 'gruppe': 'Infektionen', 'such': 'Anti-HBc Hepatitis B c IgG Hepatitis B c IgG (Anti-HBc) Infektionsserologie'},
    ...
    {'key': 'hepatitis_c_ig', 'label': 'Hepatitis C Virus Ig (Anti-HCV)', 'unit': 'S/CO', 'min': 0.0, 'max': 0.99, 'gruppe': 'Infektionen', 'such': 'Anti-HCV Hepatitis C Virus Ig Hepatitis C Virus Ig (Anti-HCV) Infektionsserologie'},
    {'key': 'hiv_screening', 'label': 'HIV 1/2 AK Screening', 'unit': 'S/CO', 'min': 0.0, 'max': 0.99, 'gruppe': 'Infektionen', 'such': 'HIV HIV 1/2 AK Screening Infektionsserologie'},
