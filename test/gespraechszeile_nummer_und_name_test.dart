...
/// Zeilen wie „V10001" sagt niemandem, mit wem er schreibt.
///
...
void main() {
  ...
  testWidgets('zeigt Nummer UND Namen', (tester) async {
    await tester.pumpWidget(zeile({
      ...
      'gegenueber_name': 'I. C. Doe',
      'member_name': 'I. C. Doe',
      'unread_count': 0,
    }));
    expect(find.text('V10001'), findsOneWidget);
    expect(find.text('I. C. Doe'), findsOneWidget,
  ...
  testWidgets('ohne Nummer steht der Name oben — und nur einmal',
    ...
    await tester.pumpWidget(zeile({
      'id': 60,
      'gegenueber_name': 'A. Musterfrau',
      'unread_count': 0,
    }));
    expect(find.text('A. Musterfrau'), findsOneWidget);
  });
