...
void main() {
  ...
  group('Die echten Antworten lassen sich vollstaendig lesen', () {
    ...
    test('tiefe — der taegliche Befund', () {
      ...
      expect(bloecke.length, greaterThanOrEqualTo(6));
